...
| Chapter | State |
|---|---|
| 1, 2, 3, 4, 5, 6, 7, 9, 10 | Draft, evidence-backed from Solstein v1→v2 |
| 8 (Ticket lifecycle automation) | Draft, design-only — not yet executed in a real engagement; clearly labeled as such in the chapter |
